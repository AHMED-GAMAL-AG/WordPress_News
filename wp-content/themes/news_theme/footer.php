			...
			<div class="col-md-3 col-sm-6">
				...
				<ul class="social-media">
					<li class="social-media-icon">
						<a href="#">
							<img src="<?php echo get_template_directory_uri() . './images/social_media/Facebook.png' ?>" alt="Facebook">
						</a>
					</li>
					<li class="social-media-icon">
						<a href="#">
							<img src="<?php echo get_template_directory_uri() . './images/social_media/Instagram.png' ?>" alt="Instagram">
						</a>
					</li>
					<li class="social-media-icon">
						<a href="#">
							<img src="<?php echo get_template_directory_uri() . './images/social_media/Twitter.png' ?>" alt="Twitter">
						</a>
					</li>
					<li class="social-media-icon">
						<a href="#">
							<img src="<?php echo get_template_directory_uri() . './images/social_media/YouTube.png' ?>" alt="YouTube">
						</a>
					</li>
				</ul>
